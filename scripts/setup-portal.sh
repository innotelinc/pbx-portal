#!/bin/bash
# ═══════════════════════════════════════════════════════════════
#  Innotel PBX Customer Portal Installer (separate from setup.sh)
# ═══════════════════════════════════════════════════════════════
#  Deploys the Next.js PBX Customer Portal (port 3000) against an
...
#      APP_DIR                            # default /opt/innotel-pbx
# ═══════════════════════════════════════════════════════════════
...
HOSTNAME=0.0.0.0
# ── Generated by Innotel PBX Portal setup ──
...
echo ""
echo "╔══════════════════════════════════════════════════════════╗"
echo "║  INNOTEL PBX PORTAL — INSTALLATION COMPLETE              ║"
echo "╠══════════════════════════════════════════════════════════╣"
